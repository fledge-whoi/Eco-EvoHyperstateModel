...
```{r}
output1 <- MPM(Fe = species_info$fecundity[1], 
...
The output contains lots of information. We can check the distribution of phenotypes through time in `$pheno_distribution`.
...
Also, note the absurd exponential population growth, evidenced by the y-axis.
