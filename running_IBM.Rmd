...
The function `main_simul() ` does all the computing. We then save the output to a folder `simulations` that would need to be created if it does not exist already.
